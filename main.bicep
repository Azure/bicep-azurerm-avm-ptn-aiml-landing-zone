...
// Build model deployment array from aiFoundryDefinition (keep the existing _afModelEntries/_afModelDeployments)
var _afBaseName = substring(resourceToken, 0, 12)

// Let the AVM module create its associated resources (Search/Cosmos/Storage/KV)
var _afWantsDeps = true
...
module aiFoundry 'br/public:avm/ptn/ai-ml/ai-foundry:0.2.0' = {
  ...
  params: {
    ...
    // Bind AF-associated resources to your PDNS zones
    aiSearchConfiguration: {
      privateDnsZoneId: !_useExistingPdz.search
        ? privateDnsZoneSearch.outputs.resourceId
        : privateDnsZoneIds.search
    }
    ...
    storageAccountConfiguration: {
      blobPrivateDnsZoneId: !_useExistingPdz.blob
        ? privateDnsZoneBlob.outputs.resourceId
        : privateDnsZoneIds.blob
    }

    // AVM creates private endpoints for AF into your PE subnet
    privateEndpointSubnetId: _peSubnetId

    // Forward your requested model deployments
